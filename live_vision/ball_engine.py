...
class LatestDetection:
    def __init__(self, model_path, confidence, core_mask=None, crop_size=CROP_SIZE, min_area=8.0, max_area_fraction=0.18):
    ...
    def _run(self):
        ...
        try:
            ...
            core_mask = self.core_mask or RKNNLite.NPU_CORE_0_1_2
