...
import cv2
import numpy as np
# RKNN deployment only reuses candidate extraction helpers from this module.
# PyTorch model loading remains in the upstream project and is intentionally
# excluded here to keep board startup and memory usage small.
